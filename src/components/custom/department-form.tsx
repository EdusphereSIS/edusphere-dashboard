    ...
    <form onSubmit={handleCreateDepartment}>
        ...
        <CardContent>
            <div className="grid w-full items-center gap-4">
                ...
                <Label htmlFor="dep-name" className='text-[var(--white-text)]'>Departmental Name</Label>
                ...
                <Select value={departName} onValueChange={(value) => setDepartName(value)}>
                    <SelectTrigger id="deg" >
                    <SelectValue placeholder="Select" />
                    </SelectTrigger>
                    <SelectContent position="popper"  >
                      {universityDepartments.map(department => (
